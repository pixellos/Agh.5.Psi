...
### 1.5.1 Cele projektu
Projekt ma na celu wsparcie firmy poprzez: 
- Redukcję narzutu komunikacyjnego między ludźmi
- Krystalizację procedur istniejących w firmie
- Łatwiejszym dostępu do statystyk działalności
- Uproszczenie kontaktu sprzedawca klient, uproszczenie obsługi zamówienia przez kilku sprzedawców
- Śledzeniem stanu magazynowego i wprowadzeniem mechanizmu notyfikacji przy niedostatecznym poziomie częsci
